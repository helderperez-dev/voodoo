    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        listbox = _AutocompleteList(
            *options,
            _AutocompleteEmpty(
                empty_text, data_vd_autocomplete_empty=True, hidden=True
            ),
            id=listbox_id,
            role="listbox",
            hidden=True,
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        attrs: dict[str, Any] = {
            ...
            "role": "checkbox",
            "aria_checked": (
                "mixed" if indeterminate else "true" if checked else "false"
            ),
            "name": name,
        }
        if checked:
...
class RadioInput(Component):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if description:
            copy_children.append(Component(description, class_="vd-radio-description"))
        super().__init__(
            input_el,
